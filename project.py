def add_tuple_lists(list_a, list_b):
    ...
    Keyword arguments:
    list_a (list): - a list of tuples of integers, all of which have the same length
    list_b (list): - another list of tuples of integers, which have the same length as list_a
    ...
    if list_a: # if lists are empty, skip this and return the empty list
        ...
        added_tuples = [ # reassign to added_tuples
